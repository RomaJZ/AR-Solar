...
class SolarView: UIViewController, ARSCNViewDelegate {
...
//        self.clearScreen()
    ...
    @objc func checkNodeHit(_ gesture: UITapGestureRecognizer){
        ...
        case "sun" :
            ...
            self.addToScreen(nodes: [sun, text])
        ...
        case "mercury":
            ...
            self.addToScreen(nodes: [mercury, text])
        ...
        case "venus":
            ...
            self.addToScreen(nodes: [venus, text])
        case "earth":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [earth, text])
        ...
        case "mars":
            ...
            self.addToScreen(nodes: [mars, text])
         case "jupiter":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [jupiter, text])
        case "saturn":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [saturn, text])
        case "uranus":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [uranus, text])
        case "neptune":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [neptune, text])
        case "pluto":
            self.clearScreen()
            ...
            self.addToScreen(nodes: [pluto, text])
        case "zoom":
                self.viewDidLoad()
        default:
            print("no")
    ...
    func addToScreen(nodes: [SCNNode]){
        for node in nodes {
